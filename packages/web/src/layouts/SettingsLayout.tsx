...
import { ArrowLeft, Cpu, Bell, FolderGit2, Languages, Server, Globe } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/settings/servers', label: '服务器', icon: Server },
  { to: '/settings/proxy', label: '代理', icon: Globe },
